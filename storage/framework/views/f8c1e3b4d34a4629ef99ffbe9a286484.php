<?php $__env->startSection('title', 'Checkout - KARTEKS ENERGY SOLUTION'); ?>
    ...
    <section class="bg-gradient-to-br from-brand-600 to-brand-700 text-white">
        <div class="container mx-auto px-4 sm:px-6 py-8">
            <nav class="text-sm text-brand-100 mb-2">
                <a href="<?php echo e(route('cart.index')); ?>" class="hover:text-white">Keranjang</a>
...
?>
    ...
    <form method="POST" action="<?php echo e(route('checkout.place')); ?>" x-data="{
        selectedAddressId: <?php echo e($defaultAddress?->id ?? 'null'); ?>,
        selectedCourier: 'jne',
        shippingOptions: <?php echo e($shippingOptionsJson); ?>,
        shippingCost: 0,
        selectedService: 'REG',
        couponCode: <?php echo e($couponCodeJson); ?>,
        subtotal: <?php echo e((float) $cart->subtotal); ?>,
        discount: <?php echo e((float) $cart->discount); ?>,
        get total() {
        ...
        recalcShipping() {
            if (this.selectedAddressId) {
                fetch('<?php echo e(route("checkout.preview")); ?>', {
                    method: 'POST',
                    headers: {
                    ...
                    <div class="lg:col-span-2 space-y-5">
                        ...
                        <div class="bg-white rounded-2xl border border-gray-100 p-6">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <a href="<?php echo e(route('dashboard.addresses.create')); ?>" class="text-sm text-brand-600 hover:text-brand-700 font-medium">+ Tambah Alamat</a>
                            </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($addresses->isEmpty()): ?>
                                <p class="text-sm text-gray-500">Anda belum punya alamat. <a href="<?php echo e(route('dashboard.addresses.create')); ?>" class="text-brand-600 font-medium">Tambah alamat pertama</a></p>
                            <?php else: ?>
                                <div class="space-y-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <label class="flex items-start gap-3 p-4 border-2 rounded-xl cursor-pointer transition"
                                            :class="selectedAddressId === <?php echo e($address->id); ?> ? 'border-brand-500 bg-brand-50' : 'border-gray-200 hover:border-brand-300'">
                                            <input type="radio" name="shipping_address_id" value="<?php echo e($address->id); ?>" x-model.number="selectedAddressId" @change="recalcShipping()" class="mt-1 shrink-0" <?php echo e($address->is_primary ? 'checked' : ''); ?>>

                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 flex-wrap">
                                                    <span class="font-semibold text-gray-900"><?php echo e($address->recipient); ?></span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($address->is_primary): ?>
                                                        <span class="px-2 py-0.5 bg-brand-100 text-brand-700 text-[10px] uppercase tracking-wider font-bold rounded">Utama</span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($address->label): ?>
                                                        <span class="px-2 py-0.5 bg-gray-100 text-gray-600 text-[10px] uppercase tracking-wider font-bold rounded"><?php echo e($address->label); ?></span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                                <div class="text-sm text-gray-600 mt-1"><?php echo e($address->phone); ?></div>
                                                <div class="text-sm text-gray-700 mt-2"><?php echo e($address->address_line_1); ?>, <?php echo e($address->address_line_2 ? $address->address_line_2 . ', ' : ''); ?><?php echo e($address->village ? $address->village . ', ' : ''); ?><?php echo e($address->district); ?>, <?php echo e($address->city); ?>, <?php echo e($address->province); ?> <?php echo e($address->postal_code); ?></div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($address->notes): ?>
                                                    <div class="text-xs text-gray-500 mt-2">Catatan: <?php echo e($address->notes); ?></div>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        </label>
                        ...
                        <div class="bg-white rounded-2xl border border-gray-100 p-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" name="customer_name" value="<?php echo e(auth()->user()->name); ?>" required class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-1">Email</label>
                                    <input type="email" name="customer_email" value="<?php echo e(auth()->user()->email); ?>" required class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 mb-1">WhatsApp</label>
                                    <input type="tel" name="customer_phone" value="<?php echo e(auth()->user()->phone); ?>" required class="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500">
                                </div>
                                <div class="sm:col-span-2">
                        ...
                        <div class="bg-white rounded-2xl border border-gray-100 p-6">
                            ...
                            <div class="space-y-3 mb-4 pb-4 border-b border-gray-100 max-h-72 overflow-y-auto">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cart->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <?php $itemable = $item->itemable; ?>
                                    <div class="flex gap-3 text-sm">
                                        <div class="w-14 h-14 bg-gray-50 rounded-lg overflow-hidden shrink-0">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($itemable && method_exists($itemable, 'getFirstMediaUrl') && $itemable->getFirstMediaUrl('images', 'thumb')): ?>
                                                <img src="<?php echo e($itemable->getFirstMediaUrl('images', 'thumb')); ?>" class="w-full h-full object-cover">
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <div class="font-medium text-gray-900 line-clamp-2 text-xs"><?php echo e($itemable->name ?? 'Produk'); ?></div>
                                            <div class="text-xs text-gray-500 mt-0.5"><?php echo e($item->qty); ?> × Rp <?php echo e(number_format($item->price_snapshot, 0, ',', '.')); ?></div>
                                        </div>
                                        <div class="font-semibold text-gray-900 text-xs whitespace-nowrap">Rp <?php echo e(number_format($item->qty * $item->price_snapshot, 0, ',', '.')); ?></div>
                                    </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cart->coupon_code): ?>
                                <div class="mt-4 p-3 bg-brand-50 rounded-lg flex items-center justify-between">
                                    <span class="text-xs font-semibold text-brand-700">Coupon: <?php echo e($cart->coupon_code); ?></span>
                                    <form method="POST" action="<?php echo e(route('cart.removeCoupon')); ?>">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\karteks-energy-solution\resources\views/pages/checkout/index.blade.php ENDPATH**/ ?>