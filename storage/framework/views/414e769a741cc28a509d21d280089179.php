<?php $__env->startSection('title', 'Keranjang Belanja - KARTEKS ENERGY SOLUTION'); ?>
...
<?php $__env->startSection('content'); ?>
    <section class="bg-gradient-to-br from-brand-600 to-brand-700 text-white">
        <div class="container mx-auto px-4 sm:px-6 py-10">
            ...
            <p class="text-brand-100 mt-1"><?php echo e($cart->items->count()); ?> item di keranjang Anda</p>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4 sm:px-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cart->items->isEmpty()): ?>
                <div class="bg-white rounded-2xl border border-gray-100 p-12 text-center">
                    ...
                    <a href="<?php echo e(route('catalog.index')); ?>" class="inline-block mt-6 px-6 py-3 bg-brand-600 text-white font-semibold rounded-full hover:bg-brand-700 transition">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cart->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <div class="flex gap-4 p-4 border-b border-gray-100 last:border-0">
                                    <a href="<?php echo e($itemable ? route('catalog.show', $itemable->slug) : '#'); ?>" class="shrink-0 w-24 h-24 bg-gray-50 rounded-xl overflow-hidden">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($imageUrl): ?>
                                            <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($itemable->name ?? 'Produk'); ?>" class="w-full h-full object-cover">
                                        <?php else: ?>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <a href="<?php echo e($itemable ? route('catalog.show', $itemable->slug) : '#'); ?>" class="font-semibold text-gray-900 hover:text-brand-700 line-clamp-2"><?php echo e($itemable->name ?? 'Produk tidak tersedia'); ?></a>
                                        <div class="text-sm text-gray-500 mt-1">Rp <?php echo e(number_format($displayPrice, 0, ',', '.')); ?></div>

                                        <div class="flex items-center justify-between mt-3 gap-2">
                                            <form method="POST" action="<?php echo e(route('cart.update', $item->id)); ?>" class="flex items-center border border-gray-200 rounded-full overflow-hidden">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PUT'); ?>
                                                <button type="submit" name="qty" value="<?php echo e(max(1, $item->qty - 1)); ?>" class="px-3 py-1 text-gray-500 hover:bg-gray-100">−</button>
                                                <span class="px-3 py-1 text-sm font-medium border-x border-gray-200 min-w-[3rem] text-center"><?php echo e($item->qty); ?></span>
                                                <button type="submit" name="qty" value="<?php echo e($item->qty + 1); ?>" class="px-3 py-1 text-gray-500 hover:bg-gray-100">+</button>
                                            </form>

                                            <div class="flex items-center gap-3">
                                                <span class="font-bold text-brand-700">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></span>
                                                <form method="POST" action="<?php echo e(route('cart.remove', $item->id)); ?>" onsubmit="return confirm('Hapus item ini?')">
                                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="flex justify-between">
                            <a href="<?php echo e(route('catalog.index')); ?>" class="text-sm text-brand-600 hover:text-brand-700 font-medium">← Lanjut Belanja</a>
                            <form method="POST" action="<?php echo e(route('cart.clear')); ?>" onsubmit="return confirm('Kosongkan semua item?')">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                    ...
                    <aside class="lg:sticky lg:top-20 lg:self-start space-y-4">
                        <div class="bg-white rounded-2xl border border-gray-100 p-6">
                            ...
                            <dl class="space-y-2 text-sm">
                                <div class="flex justify-between">
                                    <dt class="text-gray-600">Subtotal (<?php echo e($cart->items->sum('qty')); ?> item)</dt>
                                    <dd class="font-semibold">Rp <?php echo e(number_format($cart->subtotal, 0, ',', '.')); ?></dd>
                                </div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cart->discount > 0): ?>
                                    <div class="flex justify-between text-brand-700">
                                        <dt>Diskon <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cart->coupon_code): ?>(<?php echo e($cart->coupon_code); ?>)<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></dt>
                                        <dd class="font-semibold">− Rp <?php echo e(number_format($cart->discount, 0, ',', '.')); ?></dd>
                                    </div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                <div class="flex justify-between border-t border-gray-100 pt-3 mt-3">
                                    <dt class="font-bold text-gray-900">Total</dt>
                                    <dd class="font-bold text-xl text-brand-700">Rp <?php echo e(number_format($cart->total, 0, ',', '.')); ?></dd>
                                </div>
                            </dl>

                            <a href="<?php echo e(auth()->check() ? route('checkout.index') : route('login')); ?>" class="block w-full text-center mt-6 px-6 py-3 bg-brand-600 text-white font-semibold rounded-full hover:bg-brand-700 transition shadow-lg">
                            ...
                            <div class="mt-6 pt-6 border-t border-gray-100">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cart->coupon_code): ?>
                                    <div class="flex items-center justify-between p-3 bg-brand-50 rounded-lg">
                                        <div>
                                            <div class="text-sm font-semibold text-brand-700"><?php echo e($cart->coupon_code); ?></div>
                                ...
                                <?php else: ?>
                                    <form method="POST" action="<?php echo e(route('cart.applyCoupon')); ?>">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['coupon'];
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\karteks-energy-solution\resources\views/pages/cart/index.blade.php ENDPATH**/ ?>