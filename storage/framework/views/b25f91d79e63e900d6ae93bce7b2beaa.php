...
<a href="<?php echo e($productUrl); ?>" class="group block bg-white rounded-2xl overflow-hidden border border-gray-100 hover:shadow-lg hover:border-brand-200 transition">
    <div class="aspect-square bg-gray-50 overflow-hidden relative">
        <?php $cardImage = $product->featuredImageUrl; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cardImage): ?>
            <img src="<?php echo e($cardImage); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover group-hover:scale-105 transition duration-500" loading="lazy">
        <?php else: ?>
